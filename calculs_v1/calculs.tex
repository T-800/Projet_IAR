...
$$ P_A(\lambda) = \lambda^4 - \lambda^3(A_{33} + A_{44}) + \lambda^2(A_{33}A_{44} - A_{34}A_{43} + A_{42} + A_{31}) +$$ $$\lambda(A_{32}A_{43} - A_{33}A_{42} - A_{31}A_{44} + A_{34}A_{41}) + A_{31}A_{42} - A_{32}A_{41} $$
\end{document}
