...
% Creation d'un fichier ou on va mettre tout les coef du poly
% caracteristique et la bonne valeur de qd1
fid = fopen('Data/gains_tracking.txt','w');

vals_dotqd2 = [0 0 -0.25 0];

for i=1:4
    f = - dotqd1 * c4 * sin(vals_qd1(i)) - (dotqd1 + vals_dotqd2(i)) * c5 * sin(vals_qd1(i) + vals_qd2(i));
